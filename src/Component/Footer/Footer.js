          ...
          <div className="row">
            <div className="Footer">
              ...
              <div className="footer ">
                ...
                <p className="text">Delivery Details</p>
              ...
              <div className="footer">
                ...
                <p className="text">Manage Deliveries</p>
                <p className="text">Orders</p>
                <p className="text">Payments</p>
              </div>
              <div className="footer">
                <p className="bold">Resources</p>
                <p className="text">Free eBooks</p>
                <p className="text">Development Tutorial</p>
                <p className="text">How to - Blog</p>
                <p className="text">Youtube Playlist</p>
              </div>
            </div>
          </div>
          <hr />
